# DirectDebitSubmissionNightyJob.Tests

This is the test project for the DirectDebitSubmissionNightyJob application.
...
See the [BaseSteps class](/DirectDebitSubmissionNightyJob.Tests/E2ETests/Steps/BaseSteps.cs) for more details.
